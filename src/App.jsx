...
const App = () => {
  return (
    <BrowserRouter>
      ...
      <Routes>
        <Route exact path="/" element={<Home greeting={'Hi! Welcome to Gallery Portal'} welcome={"Here you can find your favorite painting. It's amazing, go ahead, enjoy the experience."} />} />
        ...
        <Route exact path="/gallery" element={<ItemListContainer products={[{id: 1, title: "Waterfalls", description: "Beautiful waterfalls, that shine in your home.", price: 750, image: image1},
